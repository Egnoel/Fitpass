...
export type ClassSessionReference = {
  _ref: string;
  _type: "reference";
  _weak?: boolean;
...
export type Booking = {
  ...
  _updatedAt: string;
  _rev: string;
  user?: UserProfileReference;
  classSession?: ClassSessionReference;
...
export type ACTIVITIES_QUERY_RESULT = Array<{
  _id: string;
  name: string | null;
  slug: Slug | null;
...
export type ACTIVITY_BY_SLUG_QUERY_RESULT = {
  _id: string;
  name: string | null;
  slug: Slug | null;
  instructor: string | null;
...
export type AI_SEARCH_ACTIVITIES_QUERY_RESULT = Array<{
  _id: string;
  name: string | null;
  instructor: string | null;
  duration: number | null;
...
export type AI_CLASS_SESSIONS_QUERY_RESULT = Array<{
  _id: string;
...
export type AI_SEARCH_VENUES_QUERY_RESULT = Array<{
  _id: string;
  name: string | null;
...
export type AI_CATEGORIES_QUERY_RESULT = Array<{
  _id: string;
  name: string | null;
  description: string | null;
}>;
...
export type AI_USER_ALL_BOOKINGS_QUERY_RESULT = Array<{
  _id: string;
  status: "attended" | "cancelled" | "confirmed" | "noShow" | null;
  createdAt: string | null;
  attendedAt: string | null;
...
export type USER_BOOKINGS_QUERY_RESULT = Array<{
  _id: string;
  status: "attended" | "cancelled" | "confirmed" | "noShow" | null;
  createdAt: string | null;
  attendedAt: string | null;
...
export type USER_UPCOMING_BOOKINGS_QUERY_RESULT = Array<{
  _id: string;
  status: "attended" | "cancelled" | "confirmed" | "noShow" | null;
  createdAt: string | null;
  classSession: {
...
export type USER_PROFILE_BY_CLERK_ID_QUERY_RESULT = {
  _id: string;
  clerkId: string | null;
  email: string | null;
  firstName: string | null;
...
export type USER_PROFILE_WITH_PREFERENCES_QUERY_RESULT = {
  _id: string;
  firstName: string | null;
  lastName: string | null;
  email: string | null;
...
export type USER_PROFILE_ID_QUERY_RESULT = {
  _id: string;
} | null;
...
export type EXISTING_BOOKING_QUERY_RESULT = {
  _id: string;
} | null;
...
export type SESSION_FOR_BOOKING_QUERY_RESULT = {
  _id: string;
  startTime: string | null;
  maxCapacity: number | null;
...
export type BOOKING_FOR_CANCEL_QUERY_RESULT = {
  _id: string;
  status: "attended" | "cancelled" | "confirmed" | "noShow" | null;
  classSession: {
    startTime: string | null;
...
export type BOOKING_FOR_ATTENDANCE_QUERY_RESULT = {
  _id: string;
  status: "attended" | "cancelled" | "confirmed" | "noShow" | null;
  classSession: {
    _id: string;
...
export type MONTHLY_BOOKINGS_COUNT_QUERY_RESULT = number;
...
export type USER_SESSION_BOOKING_QUERY_RESULT = {
  _id: string;
  status: "attended" | "cancelled" | "confirmed" | "noShow" | null;
} | null;
...
export type CANCELLED_BOOKING_QUERY_RESULT = {
  _id: string;
} | null;
...
export type USER_BOOKED_SESSION_IDS_QUERY_RESULT = Array<string | null>;
...
export type UPCOMING_SESSIONS_QUERY_RESULT = Array<{
  _id: string;
  startTime: string | null;
  maxCapacity: number | null;
  status: "cancelled" | "completed" | "scheduled" | null;
...
export type SESSION_BY_ID_QUERY_RESULT = {
  _id: string;
  startTime: string | null;
  maxCapacity: number | null;
  status: "cancelled" | "completed" | "scheduled" | null;
...
export type SESSIONS_BY_ACTIVITY_QUERY_RESULT = Array<{
  _id: string;
  startTime: string | null;
  maxCapacity: number | null;
  status: "cancelled" | "completed" | "scheduled" | null;
...
export type FILTERED_SESSIONS_QUERY_RESULT = Array<{
  _id: string;
  startTime: string | null;
  maxCapacity: number | null;
  status: "cancelled" | "completed" | "scheduled" | null;
...
export type SEARCH_SESSIONS_QUERY_RESULT = Array<{
  _id: string;
  startTime: string | null;
  maxCapacity: number | null;
  status: "cancelled" | "completed" | "scheduled" | null;
...
export type VENUES_QUERY_RESULT = Array<{
  _id: string;
  name: string | null;
  slug: Slug | null;
  description: string | null;
...
export type VENUE_BY_SLUG_QUERY_RESULT = {
  _id: string;
  name: string | null;
  slug: Slug | null;
  description: string | null;
...
export type VENUE_NAME_BY_ID_QUERY_RESULT = {
  _id: string;
  name: string | null;
} | null;
...
export type VENUES_WITH_SESSIONS_QUERY_RESULT = Array<{
  _id: string;
  name: string | null;
  slug: Slug | null;
  address: {
...
declare module "@sanity/client" {
  interface SanityQueries {
    '*[\n  _type == "activity"\n] | order(name asc) {\n  _id,\n  name,\n  slug,\n  instructor,\n  duration,\n  tierLevel,\n  "image": images[0],\n  category->{\n    _id,\n    name,\n    slug\n  }\n}': ACTIVITIES_QUERY_RESULT;
    '*[\n  _type == "activity"\n  && slug.current == $slug\n][0]{\n  _id,\n  name,\n  slug,\n  instructor,\n  duration,\n  tierLevel,\n  description,\n  images,\n  price,\n  aiKeywords,\n  category->{\n    _id,\n    name,\n    slug\n  }\n}': ACTIVITY_BY_SLUG_QUERY_RESULT;
    '*[\n  _type == "activity"\n] | order(name asc) [0...20] {\n  _id,\n  name,\n  instructor,\n  duration,\n  tierLevel,\n  aiKeywords,\n  category->{name}\n}': AI_SEARCH_ACTIVITIES_QUERY_RESULT;
