...
export default async function BookingsPage() {
    ...
    // Sanity's live fetch may return branded string types (StegaString). Cast
    // to the generated query result type so components receive the expected
    // plain string unions from `sanity.types.ts`.
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const typedBookings = (bookings ?? []) as unknown as import("@/sanity.types").USER_BOOKINGS_QUERY_RESULT;

    // Filter out bookings with invalid data
    const validBookings = typedBookings.filter(
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto px-4 py-8 space-y-8">
                ...
                <AttendanceAlert bookings={typedBookings} />
                ...
                <section>
                    ...
                    <BookingsCalendarView bookings={typedBookings} />
                </section>
