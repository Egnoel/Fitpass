...
export default async function ClassDetailPage({ params }: PageProps) {
    ...
    const tierColorKey = (tierLevel as unknown as keyof typeof TIER_COLORS) || "basic";
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="relative aspect-video rounded-2xl overflow-hidden bg-muted">
                            ...
                            {tierLevel && (
                                <Badge
                                    className={`absolute left-4 top-4 ${TIER_COLORS[tierColorKey] || TIER_COLORS.basic} border-0 text-sm px-3 py-1`}
                                >
                                    {String(tierLevel).charAt(0).toUpperCase() + String(tierLevel).slice(1)} Tier
                                </Badge>
                            )}
                        </div>
